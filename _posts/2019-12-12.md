...
White reminds that they currently running the second pilot which can be found on [https://share.neic.no](https://share.neic.no). This is a running service that can be used to register other services, and they can be verified for compliance with the EOSC Service Description Template.
