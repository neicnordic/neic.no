...
### Development project
•	call text for development project [ADD HYPERLINK]
•	guidelines for development project plan [ADD HYPERLINK]
•	guidelines for the tools and services section [ADD HYPERLINK]
other relevant documents the proposers should familiarise themselves with
•	NeIC strategy 
•	development project plan template (available in the application portal)  [ADD HYPERLINK]
•	external expert review report template [ADD HYPERLINK]
### Community-forming pre-study
•	call text for community-forming pre-study [ADD HYPERLINK]
•	guidelines for pre-study project plan [ADD HYPERLINK]
other relevant documents the proposers should familiarise themselves with
•	NeIC strategy
