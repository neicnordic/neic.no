---
title: Second phase of NordIQuEst has kicked off
summary: "The Nordic-Estonian Quest for Quantum Computing E-Infrastructure Quest, also known as NordIQuEst, works to create an environment of several Nordic quantum computers coupled with traditional supercomputing resources. The project has entered its second phase with a new project manager."
...
A new project manager has been appointed for NordIQuEst2. The new manager, **Ulf Tigerstedt**, works at CSC - IT Center for Science and was involved in the project during phase one. Ulf works as a senior application specialist, and his background is in distributed computing, distributed storage and high performance computing.

> “We’ll work hard to maintain the momentum from the original NordIQuEst.” 
> - Project Manager Ulf Tigerstedt.

The project also has a new project owner. Senior Advisor **Emma-Lisa Hansson** is a new addition to NeIC’s executive team but has previously been working in the Puhuri project. 
– Stepping into the Project Owner role for NordIQuEst2 is a professional honour. As my first Project Owner position, I hope to bring a fresh, focused perspective and a commitment to the project's success.
