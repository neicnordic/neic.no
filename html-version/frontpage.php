<?php include "header.php"; ?>
  <section class="banner">
  	<video autoplay loop class="bg-video" style="width:100% ; height: auto; min-width:100%; min-height:100%; object-fit: cover; preload=auto; position:absolute; z-index: -1; " poster="images/banner.png">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <video loop class="bg-video-mob" style="width:100% ; height: auto; min-width:100%; min-height:100%; object-fit: cover; preload=auto; z-index: 0;" controls="false"  poster="images/banner.png">
				<source src="video/abstract-rainbow_wjpctkdes__PM.mp4" type="video/mp4">
			</video>
  ...
  <section class="current-events">
	...
	<div class="row">
		<div class="event-wrap">
			<div class="right-event" style="background-image: url(images/current-event-bg.png);"></div>
  ...
  <section class="mission" style="background-image: url(images/our-mission-bg.png);">
	<div class="container">
  ...
  <section class="latest-news">
	<div class="container">
		...
		<p>Mauris mauris nunc, condimentum eget quam sit amet, ullamcorper sodales augue. Suspendisse sodales felis quam. Quisque mauris nisl, dignissim et dolor vel.</p>
			...
			<div class="left-news">
				<div class="mob news-bg" style="background-image: url(images/news-blog-1.png);"></div>
				...
				<div class="desktop news-bg" style="background-image: url(images/news-blog-1.png);"></div>
		...
		<div class="right-news">
				...
				<div class="desktop news-bg" style="background-image: url(images/news-blog-2.png);"></div>
				<div class="mob news-bg" style="background-image: url(images/news-blog-2.png);"></div>
				<div class="lite-white-bg">
		...
		<div class="left-news">
				...
				<div class="mob news-bg" style="background-image: url(images/news-blog-3.png);"></div>
				<div class="lite-white-bg">
			...
			<div class="desktop news-bg" style="background-image: url(images/news-blog-3.png);"></div>
